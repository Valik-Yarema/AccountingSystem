        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeCommodity = table.Column<int>(nullable: false),
                    Name = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactInfos_Buyers_BuyerId",
                        column: x => x.BuyerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommoditiesBuyers", x => new { x.BuyerId, x.CommodityId });
                    table.ForeignKey(
                        name: "FK_CommoditiesBuyers_Buyers_BuyerId",
                        column: x => x.BuyerId,
                        principalTable: "Buyers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommoditiesBuyers_Commodities_CommodityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommoditiesBuyers_CommodityId",
                table: "CommoditiesBuyers",
                column: "CommodityId");
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "NameCompany",
                unique: true,
                filter: "[NameCompany] IS NOT NULL");
